...
public class Auction extends BaseAuction {
    ...
    public Auction(@NonNull Court court, @NonNull String fileNumber, @NonNull Set<PropertyType> propertyTypes, @NonNull Address address, LocalDateTime appointment, @NonNull Integer amount,
            ...
            List<String> expertiseReportLinks, Set<String> otherFileLinks, String sourceUrl, AuctionSource source, List<Document> documents) {
        super(court, fileNumber, propertyTypes, address, appointment, amount, buyLimit, outdoorDescription, propertyBuildingDescription, propertyPlotDescription, expertiseDescription, sourceUrl,
                source, documents);
    }
