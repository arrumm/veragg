...
public class HanmarkCrawler_when_parseAuction_is_called {
    ...
    public void and_valid_pageData_is_passed_then_auction_returned() throws Exception {
        ...
        //
        //        assertEquals("Ort und Einwohnerzahl: Hontheim ist eine Ortsgemeinde in der südlichen Vulkaneifel. Sie gehört zur Verbandsgemeinde Traben- Trarbach. Der Ort liegt am Randes des
        //        Kondelwalds " +
        //                        "und ist umgeben von den Bächen Alf sowie Üss. Hontheim hat ca. 800 Einwohner und verfügt über eine Kindertagesstätte. Eine Grundschule ist in Hontheim nicht
        //                        vorhanden
        //                        .\n" +
        //                        "Überörtliche Anbindung/Entfernungen: Durch Hontheim verläuft die Bundesstraße 421, die von der belgischen Grenze bis in den Hunsrück führt. Zudem hat der Ort eine
        //                        gute " +
        //                        "Anbindung an" +
        //                        " die Autobahn A1 Kelberg - Trier - Saarbrücken. Die Entfernung bis zur Anschlussstelle Hasborn (123) beträgt ca. 13 km. Die Entfernungen zu den nächstgelegenen
        //                        Städten " +
        //                        "betragen: ca" +
        //                        ". 5 km bis nach Bad Bertrich, ca. 18 km bis nach Wittlich, ca. 19 km bis nach Zell, ca. 24 km bis nach Traben- Trarbach, ca. 28 km bis nach Daun, ca. 29 km bis nach
        //                        Cochem," +
        //                        " ca. 37 " + "km bis zum Flughafen Frankfurt- Hahn, ca. 42 km bis nach Schweich.\nInnerörtliche Lage: Das zu bewertenden Grundstück liegt im nördlichen Zentrum von
        //                        Hontheim" + ".\n" +
        ...
        //                        "Straßenart: Ortsstraße\nAnschlüsse an Versorgungsleitungen: Flurstück 36/2: Die Wasser-, Abwasser- und Elektrizitätsversorgung sind an das öffentliche Netz
        //                        angeschlossen.\n",
        //                result.getPlotDescription());
        //
        //        assertEquals("Hinweis: Der Sachverständigen wurde beim Ortstermin nur eine eingeschränkte Besichtigung des Gebäudes gestattet. Es hat eine Führung in Räume des Erd- und
        //        Dachgeschosses
        //        " +
        //                        "stattgefunden. Hierbei durften keine Aufzeichnungen angefertigt werden.\n" + "Art des Gebäudes: Wohnhaus, teil unterkellert\n" + "Baujahr: unbekannt, vermutlich vor
        //                        1900\n" +
        ...
        //                        "· Obergeschoss: 2 Treppenhäuser, 2 Flure, Wohnzimmer, Küche, Abstellraum, WC, 2 Schlafzimmer, Bad, Abstellraum\n" + "· Dachgeschoss: Treppenhaus, Wohn-/Esszimmer,
        //                        Küche, " + "Bad\n" +
        //                        "Gebäudekonstruktion\n" + "Konstruktionsart: Massivbauweise\n" + "Fundamente: unbekannt\n" + "Wände: Außen- und Innenwände: massives Mauerwerk\n" +
        //                        "Geschossdecken: " +
        //                        "unbekannt\n" +
        //                        "Hauseingangs-/Nebeneingangsbereich: nicht überdachter Hauseingang mit einer Eingangsstufe, Oberbelag aus Naturstein; Nebeneingang: nicht überdachter Nebeneingang mit
        //                        drei " +
        //                        "Eingangsstufen, Oberbelag aus Fliesen\n" +
        //                        "Treppen: KG: Treppe aus Beton, Oberbelag aus Werkstein; EG: Spindeltreppe und Geländer in Stahlkonstruktion mit 14 Stufen aus Naturstein; OG: Spindeltreppe und
        //                        Geländer in " +
        //                        "Stahlkonstruktion mit 15 Stufen aus Naturstein\n" + "Dach: Dachkonstruktion: Holzkonstruktion; Dachform: Satteldach; Dacheindeckung: Betondachsteine; Kamin:
        //                        gemauert\n" +
        ...
        //                        "Türen: Haustür: Hauseingangstür aus PVC mit Glasausschnitten in Isolierverglasung; Nebeneingangstür: Tür aus PVC; Zimmertüren: soweit ersichtlich überwiegend
        //                        Holztüren mit " +
        ...
        //                        "Rauchmelderpflicht Rheinland-Pfalz, welche im § 44 der Landesbauordnung (LBauO) Rheinland- Pfalz geregelt ist, müssen alle Schlafzimmer, alle Kinderzimmer und alle
        //                        Flure, " +
        //                        "die als Fluchtweg dienen, mit jeweils einem Rauchmelder ausgestattet sein. Ob in allen Räumen die erforderlichen Rauchmelder installiert sind konnte nicht überprüft
        //                        werden," +
        ...
        //                        "Allgemeinbeurteilung: Bei dem zu bewertenden Objekt handelt es sich um ein Wohnhaus, welches mit einem Gewölbekeller teilunterkellert ist. Das Wohnhaus wurde ca.
        //                        1999
        //                        durch" +
        //                        " einen seitlichen Anbau sowie mit einem neuen Treppenhaus erweitert. Ebenso wurde das Dachgeschoss aufgestockt und der Dachstuhl erneuert. Aufgrund der
        //                        Gebäudekonzeption " +
        ...
        //                        "Allgemeinbeurteilung: Bei dem zu bewertenden Objekt handelt es sich um eine Garage mit einem Stellplatz für einen PKW. Die Funktionalität des Stellplatzes ist
        //                        gegeben
        //                        .\n",
