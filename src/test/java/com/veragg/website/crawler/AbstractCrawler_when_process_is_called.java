...
public class AbstractCrawler_when_process_is_called {
    ...
    //        PowerMockito.mockStatic(PageDataService.class);
    ...
    //        PowerMockito.when(PageDataService.getPageContent(eq(AUCTION_URL))).thenReturn(AUCTION_URL_CONTENT);
    //
    ...
    //            add(AUCTION_URL);
    //        }}).when(sut).collectAuctionUrls(anyString(), anyInt(), any(), any());
    //        PowerMockito.when(PageDataService.getPageContent(eq(ANOTHER_AUCTION_URL))).thenReturn(ANOTHER_AUCTION_URL_CONTENT);
    //        PowerMockito.when(PageDataService.getPageContent(eq(AUCTION_URL))).thenReturn(AUCTION_URL_CONTENT);
    //
    //        HanmarkAuctionDTO oneAuctionDTO = mock(HanmarkAuctionDTO.class);
    ...
    //            add(AUCTION_URL);
    //        }}).when(sut).collectAuctionUrls(anyString(), anyInt(), any(), any());
    //        PowerMockito.when(PageDataService.getPageContent(eq("auctionUrlNPE"))).thenReturn(AUCTION_URL_CONTENT);
    //        PowerMockito.when(PageDataService.getPageContent(eq(AUCTION_URL))).thenReturn(AUCTION_URL_CONTENT);
    ...
    //
    //        //Assert
    //        PowerMockito.verifyStatic(PageDataService.class, times(1));
